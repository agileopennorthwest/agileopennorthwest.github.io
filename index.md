...
continental breakfast and lunch. The cost is $250.00. You can find more details about the event [here]({{ site.next-other-event-url }}). Register today using the green button above!
{: class="lead"}
