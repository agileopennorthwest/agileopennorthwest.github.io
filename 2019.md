...
sponsors:
  - url: http://www.agilealliance.org/
    ...
    text: |
      [Agile Alliance](http://www.agilealliance.org/) is a nonprofit organization dedicated to promoting the concepts of Agile 
  ...
  - url: http://osius.org
    ...
    text: |
      The [Open Space Institute(US)](http://osius.org) holds space for Open Space. The Open Space Institute(US) serves by 
  ...
  - url: http://www.pnsqc.org/
    img: pnsqc2018.jpg
    text: |
      <strong>The Pacific Northwest Software Quality Conference - [PNSQC](http://www.pnsqc.org/)</strong> 
