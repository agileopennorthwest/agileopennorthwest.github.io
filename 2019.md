...
sponsors:
  ...
  - url: https://www.cprime.com/
    img: cPrime_logo.png
    text: |
      [cPrime](https://www.cprime.com/){:target="_blank"}, an ALTEN Group Company, is a full service consultancy that helps companies deliver the 
      extraordinary through consulting, managed services and custom solutions for thousands of software teams, including more than half of the 
      Fortune 100. Cprime is a leader in Agile / Scrum transformation services, one of the largest Agile training companies in the United States, 
      Atlassian Platinum Solution Partner and Verified Vendor, Gold SCPT SAFe /Platform Partner and a well established DevOps solution provider. 
      For more information, please visit [http://www.cprime.com](https://www.cprime.com){:target="_blank"}. Follow Cprime on Twitter at @CprimeInc.
