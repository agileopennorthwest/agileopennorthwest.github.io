...
notes-preview:  
notes-url: AONW_2023_Proceedings.pdf
graphic-recording-url: AONW_2023_Graphic_Recording.pdf
notes-email:
notes-section: true
...
- url: https://www.scrumalliance.org
  img: Agile_Open_Northwest_Conference_Promo.png
  text: |
    <b>Save 10% on the Global Scrum Gathering 2023 Portland and Beyond!</b> Agile Open Northwest attendees can get 10% off the price of an in-person or virtual pass to the Global Scrum Gathering taking place May 7-10, 2023. Scan the QR code at left to get your discounted pass!
...
Please check out the [graphic recording]({{ page.graphic-recording-url }}) and [session notes]({{ page.notes-url }}). We plan on continuing to do a yearly virtual conference and in addition
we hope to host a yearly in-person conference that alternates between Portland and Seattle. 
...
Please also check out the [graphic recording]({{ page.graphic-recording-url }}){:target="_blank"}.
{% else %}
